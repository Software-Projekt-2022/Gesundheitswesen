...
val ktorHtmlBuilderVersion: String by project
val postgresVersion: String by project
val kotlinWrappersSuffix: String by project

// Env Variables
val jsDeploymentPort: String by project
val jsDeploymentHost: String by project

val jsDeploymentProxy: String by project
        ...
        browser {
            runTask {
                ...
                devServer = KotlinWebpackConfig.DevServer(
                    open = false,
                    port = jsDeploymentPort.toInt(),
                    proxy = mutableMapOf(
                        "/kv/*" to "http://$jsDeploymentHost:$jsDeploymentProxy",
                        "/kvws/*" to mapOf("target" to "ws://$jsDeploymentHost:$jsDeploymentProxy", "ws" to true)
                    ),
    ...
    sourceSets {
        ...
        val backendMain by getting {
            dependencies {
                ...
                implementation("io.ktor:ktor-html-builder:$ktorHtmlBuilderVersion")
                ...
                implementation ("org.postgresql:postgresql:$postgresVersion") // JDBC Connector for PostgreSQL
            }
        }
